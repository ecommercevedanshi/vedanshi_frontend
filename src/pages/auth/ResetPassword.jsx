...
const ResetPassword = () => {
  ...
  const handleSubmit = async (values, { setSubmitting }) => {
    ...
    try {
      ...
      setServerError(err?.data?.message || "Failed to reset password. Please try again.");
      console.log(err);
    }
    setSubmitting(false);
  };
            ...
            <Form className="space-y-4">
              ...
              <div>
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <div className="relative group cursor-pointer">
                    <Info size={12} className="text-gray-400" />
                    <div className="absolute left-0 top-6 w-64 bg-bgMain text-textPrimary text-xs p-3 rounded shadow-lg opacity-0 group-hover:opacity-100 pointer-events-none transition z-50">
                      Password must contain:
                      <ul className="list-disc pl-4 mt-1 space-y-1">
                        <li>Minimum 8 characters</li>
                        <li>One uppercase letter</li>
